...
export const NewsPreview: FC<iProps> = ({ slug, title, description, dateTime, imageUrl, tags }) => {
	return (
		<div className={s.area}>
			<Link href={'/news/' + slug}><img src={imageUrl} alt="Картинка новости" className={s.image} /></Link>
